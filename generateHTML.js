   ...
   <body>
      <div class="wrapper">
         <div class="photo-header">
            <img src="${profileInfo.avatar_url}" alt="Photo of ${profileInfo.name}" />
            <h1>Hi!</h1>
            <h2>
            My name is ${profileInfo.name}!</h1>
            <h5>${profileInfo.company ? `Currently @ ${profileInfo.company}` : ""}</h5>
            <nav class="links-nav">
               ${
         ...
         <main>
            ...
            <div class="row">
               <div class="col">
                  <h3>${profileInfo.bio ? `${profileInfo.bio}` : ""}</h3>
               </div>
               </div>
               <div class="row">
               <div class="col">
                  <div class="card">
                    ...
                    <h4>${profileInfo.public_repos}</h4>
                  </div>
               </div>
                <div class="col">
                <div class="card">
